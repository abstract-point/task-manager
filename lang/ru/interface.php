...
return [
    ...
    'welcome' => [
        ...
        'text_guest' => <<<TEXT
                ...
                Зарегистрируйтесь и авторизуйтесь, чтобы создавать новые задачи, статусы и тэги.
                TEXT,
        'text_authed' => <<<TEXT
                Ура! Вы авторизованы в приложении.

                Теперь вы можете создавать новые задачи, статусы и тэги, редактировать их и удалять.

                Статусы и метки нельзя удалить, пока они привязаны хотя бы к одной задаче.
                Удалить можно лишь те задачи, автором которых вы являетесь.
                TEXT,
    ],
    'navigation' => [
        'statuses' => 'Статусы',
